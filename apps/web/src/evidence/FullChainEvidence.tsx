  ...
  return (
    <section className="full-chain" aria-labelledby="full-chain-title">
      ...
      <p className="full-chain__intro">
        {locale === "zh-CN" ? "Cloudflare V2 与 AWS 性能链均已在各自范围内进入 verified-production；Sepolia V3 仍为 pending-external。" : "Cloudflare V2 and the AWS performance chain are verified-production within their scoped evidence; Sepolia V3 remains pending-external."}
      </p>
