  ...
  return (
    <section className="full-chain" aria-labelledby="full-chain-title">
      ...
      <p className="full-chain__intro">
        {locale === "zh-CN" ? "本地 Gate 只能产生 verified-local；V2 Sepolia、AWS 与 Cloudflare 必须有新的外部回读才能离开 pending-external。" : "Local gates can produce only verified-local. V2 Sepolia, AWS and Cloudflare stay pending-external until fresh external readback exists."}
      </p>
