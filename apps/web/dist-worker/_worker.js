...
function FullChainEvidence() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "full-chain", "aria-labelledby": "full-chain-title", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "full-chain__heading", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "full-chain__eyebrow", children: "END-TO-END DELIVERY EVIDENCE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: "full-chain-title", children: "One request, every boundary" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "correlation: request_id" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "full-chain__intro", children: "A production performance sample is accepted only when the same request_id can be traced from the browser through Edge, AWS messaging, compute, persistence, public Evidence readback, and the final reversible pause." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("figure", { className: "full-chain__diagram", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("figcaption", { children: "Architecture intent. External hops remain unverified until production identifiers, screenshots and readback are captured." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "full-chain__steps", children: chain.map((step, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { "data-chain-step": index + 1, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "full-chain__index", children: String(index + 1).padStart(2, "0") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: step.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: step.detail })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { "data-status": step.status, children: step.status })
    ] }, step.name)) })
  ] });
}
const serverRoutes = [
...
function ServerApp({ pathname }) {
  const route = routeForPath(pathname);
  const title = route?.title ?? "Page not found";
  const summary = route?.summary ?? "This route is not part of the Agent Market delivery surface.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "edge-route-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", "aria-label": "Agent Market home", children: "AGENT MARKET" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { "aria-label": "Primary navigation", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/agents", children: "Agents" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/tasks", children: "Tasks" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/staking", children: "Staking" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/evidence", children: "Evidence" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "aria-labelledby": "edge-route-title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        route?.area ?? "404",
        " / EDGE ROUTE"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { id: "edge-route-title", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: summary }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Rendering" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: "Cloudflare Edge SSR" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Chain" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: "Ethereum Sepolia" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: "Evidence" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: "Requirement to verification trace" })
        ] })
      ] })
    ] }),
    pathname === "/evidence" ? /* @__PURE__ */ jsxRuntimeExports.jsx(FullChainEvidence, {}) : null
  ] });
}
function renderRouteStream(pathname, signal) {
  return server_edgeExports.renderToReadableStream(/* @__PURE__ */ jsxRuntimeExports.jsx(ServerApp, { pathname }), {
    signal,
    onError(error) {
...
function safeSerializeRenderState(state) {
...
function appendRenderState(suffix, state) {
...
function composeSsrDocument(template, app, state) {
...
function buildCsrFallbackDocument(template, state) {
  const [prefix, suffix] = splitTemplate(template);
...
function documentHeaders(mode, cache) {
  return new Headers({
    ...securityHeaders,
    "cache-control": cache,
...
async function loadTemplate(request, environment) {
  return environment.ASSETS.fetch(new Request(
    new URL("/index.html", request.url),
    { headers: { accept: "text/html" } }
  ));
}
async function renderWithTimeout(render, pathname, timeoutMs) {
...
function completedStream(bytes) {
  return new ReadableStream({
    start(controller) {
...
function createPagesHandler(options = {}) {
  ...
  const version = options.version ?? void 0 ?? "unknown";
  ...
  return {
    async fetch(request, environment) {
      ...
      if (requestUrl.pathname === "/api/performance") {
        ...
        const origin = environment.API_ORIGIN.endsWith("/") ? environment.API_ORIGIN : `${environment.API_ORIGIN}/`;
      ...
      const state = { mode: "ssr", pathname, version };
      try {
        ...
        return new Response(
          request.method === "HEAD" ? null : composeSsrDocument(template, completedStream(app), state),
          {
            status,
            headers: documentHeaders(
              "ssr",
              status === 404 || request.headers.has("cookie") ? "private, no-store" : "public, max-age=0, must-revalidate"
            )
          }
        );
      } catch (error) {
...
const pagesWorker = createPagesHandler();
export {
  createPagesHandler,
  pagesWorker as default
};
